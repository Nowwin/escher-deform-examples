...
PATTERN_PATH = "../build/exports/pattern_anteater_deformed_20250811_031054.png"
TILE_PATHS   = [
    "../build/exports/Anteater1_deformed_20250811_034125.png",
    "../build/exports/Anteater2_deformed_20250811_034125.png",
]
...
# Split of the work area below the header
SPLIT_FRAC = 0.50  # top half pattern, bottom half tiles
PATTERN_TILE_GAP = 100  # extra pixels of whitespace between pattern and tiles
...
def main():
    ...
    # Split with gap between pattern and tiles
    ...
    if not tile_imgs:
        raise RuntimeError("No tile images provided")
